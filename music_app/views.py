...
import os
# Create your views here. (varunv and tejas, when exectuing coe, after replacing, do not )
spotify = spotipy.Spotify(
    client_credentials_manager=SpotifyClientCredentials(
        client_id='9d44f1c7ffb1418a96863ef81d69e531',
        client_secret='27e35573b01d42dc8139113879f25bed'
    ),
    requests_timeout=100  # Increase the timeout for spotify api (stupid....)
)
myPlaylists = []
...
def logout(request):
    try:
        ...
        return redirect("/")
    #close all (), syntax correction done by chatgpt, logic on api set up in view chatsonic by varun dubey

def formex(request):
    return render(request,'formex.html')